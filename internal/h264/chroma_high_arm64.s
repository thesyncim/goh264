...
TEXT ·h264ChromaMCHighASM(SB), NOSPLIT, $0-72
	...
	MOVD step+56(FP), R14
	MOVW avg+64(FP), R15
	CBZW R4, chroma_high_done
	CBZW R9, chroma_high_axis_row
...
chroma_high_bilinear_col:
	...
	ADDW  $32, R12, R12
	ASRW  $6, R12, R12
	CBZW  R15, chroma_high_bilinear_store
	MOVHU (R10), R13
	ADDW  R13, R12, R12
	ADDW  $1, R12, R12
	LSRW  $1, R12, R12
chroma_high_bilinear_store:
	...
	ADD   $2, R11, R11
	SUBW  $1, R5, R5
	CBNZW R5, chroma_high_bilinear_col
	ADD   R2, R0, R0
	ADD   R3, R1, R1
	SUBW  $1, R4, R4
	CBNZW R4, chroma_high_bilinear_row
	RET
...
chroma_high_axis_col:
	...
	ADDW  $32, R12, R12
	ASRW  $6, R12, R12
	CBZW  R15, chroma_high_axis_store
	MOVHU (R10), R13
	ADDW  R13, R12, R12
	ADDW  $1, R12, R12
	LSRW  $1, R12, R12
chroma_high_axis_store:
	...
	ADD   $2, R11, R11
	SUBW  $1, R5, R5
	CBNZW R5, chroma_high_axis_col
	ADD   R2, R0, R0
	ADD   R3, R1, R1
	SUBW  $1, R4, R4
	CBNZW R4, chroma_high_axis_row
chroma_high_done:
	RET
