...
func TestValidateHighFrameSliceReconstructAllowsHigh14IntraPCMOnly(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{name: "intra4x4", mbType: MBTypeIntra4x4, cbp: 0, cbpTable: 0},
		{name: "intra16x16-no-residual", mbType: MBTypeIntra16x16, cbp: 0, cbpTable: 0},
		{name: "intra16x16-luma-dc", mbType: MBTypeIntra16x16, cbp: 0, cbpTable: 0x100},
		{name: "intra16x16-luma-chroma", mbType: MBTypeIntra16x16, cbp: 0x2f, cbpTable: 0xf02f},
	} {
		t.Run(tt.name, func(t *testing.T) {
...
func TestDecodeCAVLCFrameSliceHigh12ReconstructsIntra16x16NoResidual(t *testing.T) {
	const bitDepth = 12
	m, dst, sh := highFrameSliceDecodeFixtureWithMBWidth(t, bitDepth, 1, 1, false, PictureTypeI)
	...
	assertH264ConstantBlockHigh(t, "cavlc high12 intra16x16 y", dst.Y, 0, dst.LumaStride, 16, 16, 1<<(bitDepth-1))
	assertH264ConstantBlockHigh(t, "cavlc high12 intra16x16 cb", dst.Cb, 0, dst.ChromaStride, 8, 8, 1<<(bitDepth-1))
	assertH264ConstantBlockHigh(t, "cavlc high12 intra16x16 cr", dst.Cr, 0, dst.ChromaStride, 8, 8, 1<<(bitDepth-1))
...
func TestDecodeCAVLCFrameSliceHigh12ReconstructsIntra16x16LumaDCResidual(t *testing.T) {
	const bitDepth = 12
	m, dst, sh := highFrameSliceDecodeFixtureWithMBWidth(t, bitDepth, 1, 1, false, PictureTypeI)
	...
	assertH264RowsHigh(t, "cavlc high12 intra16x16 luma-DC y", dst.Y, 0, dst.LumaStride, 16, 16, want.Y, want.LumaStride)
	assertH264RowsHigh(t, "cavlc high12 intra16x16 luma-DC cb", dst.Cb, 0, dst.ChromaStride, 8, 8, want.Cb, want.ChromaStride)
	assertH264RowsHigh(t, "cavlc high12 intra16x16 luma-DC cr", dst.Cr, 0, dst.ChromaStride, 8, 8, want.Cr, want.ChromaStride)
...
func TestDecodeCAVLCFrameSliceHigh12ReconstructsIntra16x16ChromaACResidual(t *testing.T) {
	const bitDepth = 12
	m, dst, sh := highFrameSliceDecodeFixtureWithMBWidth(t, bitDepth, 1, 1, false, PictureTypeI)
	...
	assertH264RowsHigh(t, "cavlc high12 intra16x16 chroma-AC y", dst.Y, 0, dst.LumaStride, 16, 16, want.Y, want.LumaStride)
	assertH264RowsHigh(t, "cavlc high12 intra16x16 chroma-AC cb", dst.Cb, 0, dst.ChromaStride, 8, 8, want.Cb, want.ChromaStride)
	assertH264RowsHigh(t, "cavlc high12 intra16x16 chroma-AC cr", dst.Cr, 0, dst.ChromaStride, 8, 8, want.Cr, want.ChromaStride)
...
func TestDecodeCAVLCFrameSliceHigh12ReconstructsIntra16x16ChromaDCACResidual(t *testing.T) {
	const bitDepth = 12
	m, dst, sh := highFrameSliceDecodeFixtureWithMBWidth(t, bitDepth, 1, 1, false, PictureTypeI)
	...
	assertH264RowsHigh(t, "cavlc high12 intra16x16 chroma-DC/AC y", dst.Y, 0, dst.LumaStride, 16, 16, want.Y, want.LumaStride)
	assertH264RowsHigh(t, "cavlc high12 intra16x16 chroma-DC/AC cb", dst.Cb, 0, dst.ChromaStride, 8, 8, want.Cb, want.ChromaStride)
	assertH264RowsHigh(t, "cavlc high12 intra16x16 chroma-DC/AC cr", dst.Cr, 0, dst.ChromaStride, 8, 8, want.Cr, want.ChromaStride)
...
func TestDecodeCAVLCFrameSliceHigh12ReconstructsIntra16x16LumaChromaResidual(t *testing.T) {
	const bitDepth = 12
	m, dst, sh := highFrameSliceDecodeFixtureWithMBWidth(t, bitDepth, 1, 1, false, PictureTypeI)
	...
	assertH264RowsHigh(t, "cavlc high12 intra16x16 luma/chroma y", dst.Y, 0, dst.LumaStride, 16, 16, want.Y, want.LumaStride)
	assertH264RowsHigh(t, "cavlc high12 intra16x16 luma/chroma cb", dst.Cb, 0, dst.ChromaStride, 8, 8, want.Cb, want.ChromaStride)
	assertH264RowsHigh(t, "cavlc high12 intra16x16 luma/chroma cr", dst.Cr, 0, dst.ChromaStride, 8, 8, want.Cr, want.ChromaStride)
...
func TestDecodeCAVLCFrameSliceHigh12ReconstructsIntra16x16LumaACResidual(t *testing.T) {
	const bitDepth = 12
	m, dst, sh := highFrameSliceDecodeFixtureWithMBWidth(t, bitDepth, 1, 1, false, PictureTypeI)
	...
	assertH264RowsHigh(t, "cavlc high12 intra16x16 luma-AC y", dst.Y, 0, dst.LumaStride, 16, 16, want.Y, want.LumaStride)
	assertH264RowsHigh(t, "cavlc high12 intra16x16 luma-AC cb", dst.Cb, 0, dst.ChromaStride, 8, 8, want.Cb, want.ChromaStride)
	assertH264RowsHigh(t, "cavlc high12 intra16x16 luma-AC cr", dst.Cr, 0, dst.ChromaStride, 8, 8, want.Cr, want.ChromaStride)
...
func TestDecodeCAVLCFrameSliceHigh12ReconstructsIntra16x16LumaDCACResidual(t *testing.T) {
	const bitDepth = 12
	m, dst, sh := highFrameSliceDecodeFixtureWithMBWidth(t, bitDepth, 1, 1, false, PictureTypeI)
	...
	assertH264RowsHigh(t, "cavlc high12 intra16x16 luma-DC/AC y", dst.Y, 0, dst.LumaStride, 16, 16, want.Y, want.LumaStride)
	assertH264RowsHigh(t, "cavlc high12 intra16x16 luma-DC/AC cb", dst.Cb, 0, dst.ChromaStride, 8, 8, want.Cb, want.ChromaStride)
	assertH264RowsHigh(t, "cavlc high12 intra16x16 luma-DC/AC cr", dst.Cr, 0, dst.ChromaStride, 8, 8, want.Cr, want.ChromaStride)
