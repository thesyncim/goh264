...
var _ = (PacketSideData).AppendData
var _ = (Packet).Clone
...
var _ = (FrameSideData).AppendA53ClosedCaptions
var _ = (FrameSideData).AppendICCProfile
var _ = (FrameSideData).AppendDynamicHDR10Plus
var _ = (FrameSideData).AppendLCEVC
var _ = (FrameSideData).AppendS12MTimecodes
var _ = (*PictureTiming).Validate
var _ = (*PictureTiming).Clone
var _ = (*PictureTiming).AppendTimecodes
var _ = (*ReferenceDisplaysInfo).Validate
var _ = (*ReferenceDisplaysInfo).Clone
var _ = (*ReferenceDisplaysInfo).AppendDisplays
