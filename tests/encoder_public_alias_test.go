...
var _ = (EncoderParameterSets).AppendPPSChecked
var _ = (EncoderParameterSets).AppendAnnexB
var _ = (EncoderParameterSets).AppendAnnexBChecked
var _ = (EncoderParameterSets).AppendAVCC
var _ = (EncoderParameterSets).AppendAVCCChecked
var _ = (EncoderParameterSets).Clone
var _ = (EncoderParameterSets).CloneChecked
var _ = (EncoderSEI).AppendNAL
var _ = (EncoderSEI).AppendNALChecked
var _ = (EncoderSEI).AppendAnnexB
var _ = (EncoderSEI).AppendAnnexBChecked
var _ = (EncoderSEI).AppendAVC
var _ = (EncoderSEI).AppendAVCChecked
var _ = (EncoderSEI).Clone
var _ = (EncoderSEI).CloneChecked
