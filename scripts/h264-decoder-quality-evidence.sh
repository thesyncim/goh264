...
decoder_output_ownership_tests='^(TestDecodeConfiguredAVCFramesDoesNotAliasCallerBuffer|TestDecodeAVCCFramesDoesNotAliasCallerBuffer|TestDecodeAnnexBFramesDoesNotAliasCallerBuffer|TestDecodeAVCFramesDoesNotAliasCallerBuffer|TestDecodeFramesAutoAnnexBDoesNotAliasCallerBuffer|TestDecodeFramesAutoAVCDoesNotAliasCallerBuffer|TestDecodePacketFramesDoesNotAliasCallerBuffer|TestConfigureAVCCDoesNotAliasCallerBuffer|TestParseHeadersAnnexBDoesNotAliasCallerBuffer|TestParseHeadersAVCDoesNotAliasCallerBuffer|TestPacketSideDataCloneDeepCopiesPayload|TestPacketSideDataAppendDataReturnsCallerOwnedBytes|TestPacketCloneDeepCopiesDataAndSideData|TestPacketAppendDataReturnsCallerOwnedBytes|TestPacketAppendSideDataReturnsCallerOwnedValues|TestFrameSideDataCloneDeepCopiesNestedStorage|TestFrameSideDataNestedHelpersDeepCopyAndValidate|TestFrameSideDataAppendHelpersReturnCallerOwnedBytes|TestFrameSideDataAppendTypedHelpersReturnCallerOwnedValues|TestFrameCloneDeepCopiesPlanesAndSideData|TestDecodePacketFramesNewExtradataDoesNotAliasCallerBuffers|TestDecodePacketFramesAnnexBNewExtradataDoesNotAliasCallerBuffers|TestDecodeFrameStructuredSideDataIsCallerOwned|TestDecodeFrameSideDataByteSlicesAreCallerOwned|TestDecodeFrameSEIStructuredSideDataIsCallerOwned|TestDecodeFramePictureTimingSlicesAreCallerOwned|TestFrameRawYUVBytesLEReturnsOwnedExactBuffer|TestFrameAppendRawYUVIsolatesOverlappingSource|TestFrameAppendRawYUVErrorPreservesCallerBuffer|TestFrameAppendRawYUVHighErrorPreservesCallerBuffer)$'
decoder_public_delayed_output_tests='^(TestDecodeAVCCFramesRejectPreservesDelayedFlush|TestDecodeAVCCFramesEmptyPacketIncompatibleConfigPreservesDelayedFlush|TestDecodeFramesRejectAVCConfigurationRecordPreservesDelayedFlush|TestDecodeRejectAVCConfigurationRecordPreservesDelayedFlush|TestDecodeAVCCRejectPreservesDelayedFlush|TestDecodeAVCCEmptyPacketIncompatibleConfigPreservesSingleDelayedFlush|TestDecodePacketIgnoresNewExtradataOnSingleFrameFlush|TestDecodePacketFramesIgnoresMalformedNewExtradataOnFlush|TestDecodePacketIgnoresMalformedNewExtradataOnSingleFrameFlush|TestDecodePacketFramesRepeatedNewExtradataPreservesDelayedBFrames|TestDecodePacketFramesMalformedRepeatedNewExtradataPreservesDelayedBFrames|TestDecodeConfiguredAVCBFramesReturnsReorderedPrefixBeforeDamagedSlice|TestDecodeAVCCFramesBFramesFlushesReorderedPrefixBeforeDamagedSlice|TestParseHeadersPreservesDelayedConfiguredAVCFlush|TestParseHeadersRejectPreservesDelayedConfiguredAVCFlush)$'
...
run_exact_go_test_gate decoder-delayed-output ./internal/h264 '^(TestSimpleDecoderFlushDelayedFrameRejectsMultipleWithoutDraining)$' -count=1 -v
run_exact_go_test_gate decoder-public-delayed-output ./tests "$decoder_public_delayed_output_tests" -count=1 -v
