...
- The active Go slice covers Annex B NAL splitting, RBSP emulation-prevention removal, bit reading, unsigned/signed Exp-Golomb reads, SPS/PPS metadata parsing, scaling/QP/dequant table construction, MB-type/CBP/scan tables, CAVLC VLC/residual coefficient primitives, luma/chroma residual cache updates, intra CAVLC macroblock syntax, P/B-slice inter reference/MVD syntax, and slice-header parsing up to macroblock payload.
