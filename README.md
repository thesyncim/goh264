...
- Frame reconstruction/deblocking/motion-compensation call-site wiring, full slice-loop CAVLC/CABAC macroblock integration, B-direct/B-skip motion, high-bit-depth/SIMD transform and DSP variants, DPB, threading, and public `Decode` output are not yet implemented.
