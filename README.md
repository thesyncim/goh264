...
- Frame reconstruction, full CAVLC/CABAC macroblock prediction/motion integration, B-direct motion, residual transform write-back, inverse transform, deblocking, DPB, threading, and public `Decode` output are not yet implemented.
