...
chroma-DC+AC CAVLC coefficients through syntax decode and frame macroblock
table writeback, including nonzero `first_mb_in_slice` range isolation and
per-macroblock QP deltas.
