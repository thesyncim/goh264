...
- This safe point proves MP4-style configured AVC packets for CAVLC ref-list and Main-profile CABAC IDR/P fixtures with SPS/PPS removed from the packet and supplied through `avcC`.
