...
shifted references, and changed-frame P IntraPCM recovery pictures with
...
boundaries, clipped per-packet RTP payload and data slices, oversize mode-0
rejection, and optional RTP packet callbacks with
