...
- This safe point proves 16x16 High 4:4:4 Predictive qp=0 lossless CAVLC/CABAC IDR/P frame parity over yuv420p output across Annex B, explicit AVC, configured AVC, and configured sample-by-sample decode, with FFmpeg rawvideo MD5 oracle coverage.
