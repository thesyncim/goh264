...
Current public-vector gate: 26 selected FATE vectors, 25 green, 1 known-red.
...
GOH264_BENCH_FFMPEG=1 GOH264_BENCH_FAIR_CPU_LANES=1 scripts/h264-real-vector-bench.sh canl4 # oracle + peer raw-MD5 quality in pure/native lanes
