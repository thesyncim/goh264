...
- This safe point ports FFmpeg's recovery-point output effects for the simple frame path: public `Frame.KeyFrame`, IDR-vs-output-key separation, recovery-frame modulo tracking, and `recovery_frame_cnt == 0` key promotion proved against ffprobe.
