...
admitted IDR/P-frame Annex B/AVC/RTP canaries, which now include Annex B
odd-pixel constant-chroma P16 allocation and benchmark rows, 8-pixel exact-P16
edge-search allocation and benchmark rows, RTP P-IntraPCM, and
packetization-mode 0 IDR/P-frame allocation and benchmark rows including exact-P16
edge search.
