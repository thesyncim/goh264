...
configuration-record decode, valid packet `NEW_EXTRADATA`, and auto-detected
avcC admission all store configured-AVC state without retaining caller-owned
side-data, configuration, or packet buffers after the decode call returns.
