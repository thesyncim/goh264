...
real-vector gate passes raw-MD5 and the zero-allocation Go gate with default
partial asm around 4370 ms/sample versus about 4663 ms/sample for `purego`;
that is a 6.3% reduction, but still about 4.1x slower than FFmpeg pure-C and
