...
0 allocs/op. The clean amd64 `caba3-sva-b` real-vector gate at
...
1. Continue 8-bit deblock coverage with amd64 luma MBAFF/intra leaves and the
   remaining perf-positive chroma shapes now that normal luma vertical/horizontal
   and the enabled chroma leaves have FFmpeg-shaped amd64 assembly.
