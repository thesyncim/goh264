...
`9914cd402a0d5818821a50e5434a142d962786b2` passes raw-MD5 and the
zero-allocation Go gate with default partial asm at 157.7 ms/sample
(12.625 ns/raw-byte), versus 179.0 ms/sample (14.604 ns/raw-byte) in
`purego`, 62.8 ms/sample (5.026 ns/raw-byte) for FFmpeg pure-C, and
50.1 ms/sample (3.966 ns/raw-byte) for FFmpeg native C+asm.
