...
1. Continue 8-bit deblock coverage with amd64 chroma plus luma MBAFF/intra
   leaves now that normal luma vertical/horizontal have FFmpeg-shaped amd64
   assembly.
