...
`ed4bdd01cc5f50313536a90549b91d13bd0e24af` passes raw-MD5 and the
zero-allocation Go gate with default partial asm at 156.5 ms/sample
(12.459 ns/raw-byte), versus 181.4 ms/sample (14.476 ns/raw-byte) in
`purego`, 62.4 ms/sample (5.001 ns/raw-byte) for FFmpeg pure-C, and
48.8 ms/sample (3.884 ns/raw-byte) for FFmpeg native C+asm.
