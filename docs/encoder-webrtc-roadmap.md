...
single-NAL payload form including IDR/P frames, NAL type/count, FU-A start/end, and parameter-set
...
5. In progress: add RTP packetization and WebRTC control handling with
   ...
   bytes, callback-style packet metadata including IDR/P-frame single-NAL packets,
