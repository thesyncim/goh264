...
P IntraPCM, plus <=7 for RTP `EncodeInto` max-frame-size drops, <=8 for RTP
late drops, and stack-backed common one-slice NAL and slice-range planning,
...
P IntraPCM, RTP STAP-A IDR/changed-P, and RTP packetization-mode 0 IDR/P-frame rows including exact-P16
