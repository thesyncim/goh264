...
`Frame.Clone` deep-owned decoded-frame snapshots and `FrameSideData.Clone` side-data snapshots,
...
recovery-point toggles, preserving a queued IDR until an IDR is emitted,
