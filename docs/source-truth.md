...
reconfigure updates preserving a queued IDR until an IDR is emitted,
...
bitrate budget derivation rejection, overflowed input-plane geometry rejection,
and P-skip
...
Annex B/AVC/RTP bitrate-drop and late-drop non-output paths, checked
