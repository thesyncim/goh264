...
CABAC delayed-output reorder plus weighted/field compact rows and CAVLC
field/QP/crop compact rows,
public FATE vector harness,
raw-diff/frame-MD5 diagnostics, and CLI benchmark comparison.

Public vectors: 152/152 green. Matrix mode is the safe-point gate. Red-queue
