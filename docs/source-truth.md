...
output, paused callbacks, preserved reference/frame/packet state, and P-skip
...
`EncodeInto` allocation canaries for caller-buffer Annex B/RTP IDR, P-skip,
exact-P16x16 including RTP 8-pixel edge search, P-IntraPCM including RTP
changed P IntraPCM, and RTP packetization-mode 0 IDR/P-frame paths including
exact-P16 edge search, and a
...
and RTP packetization-mode 0 IDR/P-frame rows including exact-P16 edge search,
with `-benchmem`.
