...
fixtures including High12 CAVLC IntraPCM plus Intra16x16 luma, chroma,
and combined luma/chroma residual, High14 CAVLC IntraPCM, mixed
no-residual intra, separate and combined Intra16x16 luma/chroma residual,
public FATE vector harness, raw-diff/frame-MD5 diagnostics, and CLI
