...
RTP header bytes with clipped packet data slices, optional RTP callback metadata
including mode 0/1 IDR/P-frame single-NAL packets, initial `EncodeInto`
...
and one-buffer full RTP packet-data stamping with per-packet append isolation.
