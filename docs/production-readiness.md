...
error without consuming queued IDR state or advancing RTP/callback state, rejects
overflowed configured and per-frame input-plane geometry without wrapped sizes
or panics, and
