...
destination unchanged on invalid or overflowed-destination appends and
...
payload appends, rejected malformed dropped-result storage in `EncodedFrame.Clone`, shared
