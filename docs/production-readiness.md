...
Valid packet `NEW_EXTRADATA` and auto-detected avcC admission also prove the
stored configured-AVC state does not retain caller-owned side-data,
configuration, or packet buffers after return.
