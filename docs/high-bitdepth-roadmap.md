...
- `internal/h264/simple_decode.go` now represents decoded frames with either
  ...
  proved partitioned implicit weighted B16x8/B8x16/B8x8 subset.
- `decoder.go` exposes public `Frame.Y16/Cb16/Cr16`, `BytesPerSample`,
  ...
  CAVLC/CABAC non-direct/direct B16x16 deblock, CAVLC-only slice-boundary, and narrow yuv420p12le
  IntraPCM lanes.
...
- The current B-picture safe point is deliberately narrow: exact High 10 4:2:0
  ...
  partitioned implicit weighted B16x8/B8x16/B8x8 subset, and narrow
  CAVLC/CABAC non-direct/direct B16x16 deblock-enabled streams. Mixed
  direct/explicit B8x8, residual-bearing direct-sub, broader partitioned
  implicit weighted B, and partitioned/direct-sub/skip/implicit high B
...
- `internal/h264/reconstruct_high.go` has a separate `h264PicturePlanesHigh`
  ...
  direct/explicit B8x8, residual-bearing direct-sub B, partitioned/direct-sub/skip/implicit high B
...
- `internal/h264/reconstruct_high.go` now consumes high motion internally for
  ...
  CAVLC/CABAC non-direct and top-level direct B16x16 streams. The P-intra lane admits only Intra4x4/Intra16x16
  ...
  broader partitioned implicit weighted B, partitioned/direct-sub/skip/implicit high deblocking,
...
B16x8/B8x16/B8x8, implicit weighted B16x16, and narrow CAVLC/CABAC B16x16
high deblocking, now proved by rawvideo
oracles. Weighted partitioned P, mixed direct/explicit B8x8, residual-bearing direct-sub
B, partitioned/direct-sub/skip/implicit high deblocking, and unproved depth/chroma combinations remain
guarded.
...
5. Later: 12-bit 4:2:2 deblocking, 14-bit 4:4:4 deblocking, CABAC/chroma/B-slice
   slice-boundary, and partitioned/direct-sub/skip/implicit high B deblocking.
...
12. High-depth deblocking enabled for 4:2:0, 4:2:2, and 4:4:4.
13. Annex B, explicit AVC/NALFF, configured AVC, sample-by-sample configured
...
10. **Wire High Loop Filter**
   ...
   - Remaining tests: CABAC/chroma/B-slice public high slice-boundary proof,
     partitioned/direct-sub/skip/implicit high B deblocking, broader 12-bit/all 14-bit, and
