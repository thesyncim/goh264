...
handoff plus public CAVLC 4:2:2/4:4:4 unweighted I/P
no-deblock/mode-1/mode-2 deblock plus luma-only and luma+chroma weighted-P
...
deblock plus luma-only and luma+chroma weighted-P
...
High12/High14 CABAC/field weighted-P slice-boundary modes, broader high-bit-depth field/MBAFF motion, PIC-AFF/PAFF, and broader
