...
- QP/dequant tables are sized to `qpMaxNum == 87`, so 14-bit QP storage exists.
  ...
  B16x8/B8x16/B8x8, narrow CAVLC/CABAC non-direct and top-level direct
  B16x16 deblock-enabled, neutral and implicit-weighted partitioned
  B16x8/B8x16/B8x8 deblock-enabled, implicit-weighted B16x16
  deblock-enabled, neutral B-skip plus neutral/implicit-weighted
  B 8x8/B_SUB_4x4 direct-sub deblock-enabled, CAVLC-only
  High10 4:2:0 slice-boundary, and narrow yuv420p12le CAVLC IDR/I IntraPCM
  subsets.
- `internal/h264/simple_decode.go` now represents decoded frames with either
  ...
  deblocking disabled, the narrow CAVLC/CABAC non-direct/direct B16x16
  deblock-enabled lane, the neutral/implicit-weighted B 8x8/B_SUB_4x4
  direct-sub deblock-enabled lane,
  CAVLC-only High10 4:2:0 slice-boundary IDR/P, narrow yuv420p12le CAVLC
  IDR/I IntraPCM, or the CAVLC/CABAC B 8x8/B_SUB_4x4 direct-sub no-residual
  lane. The B route is
  ...
  B16x8/B8x16/B8x8 partitioned motion, B16x16 implicit weighting, and the
  proved partitioned implicit weighted B16x8/B8x16/B8x8 subset, including the
  narrow implicit-weighted B16x16 plus neutral and implicit-weighted
  partitioned and direct-sub high-deblock lanes.
- `decoder.go` exposes public `Frame.Y16/Cb16/Cr16`, `BytesPerSample`,
  ...
  proved non-direct, temporal/spatial direct B16x16, temporal/spatial B-skip,
  CAVLC/CABAC direct-sub B, CAVLC/CABAC partitioned P, explicit partitioned B,
  implicit weighted B16x16, partitioned implicit weighted B16x8/B8x16/B8x8,
  CAVLC/CABAC non-direct/direct B16x16 deblock, implicit-weighted B16x16
  deblock, neutral and implicit-weighted partitioned B deblock,
  neutral/implicit-weighted direct-sub B deblock,
  CAVLC-only slice-boundary, and narrow yuv420p12le
  IntraPCM lanes.
...
- The current B-picture safe point is deliberately narrow: exact High 10 4:2:0
  ...
  B16x8/B8x16/B8x8 partitions, implicit weighted B16x16, the proved
  partitioned implicit weighted B16x8/B8x16/B8x8 subset, narrow
  CAVLC/CABAC non-direct/direct B16x16 deblock-enabled streams, and
  implicit-weighted B16x16 plus neutral and implicit-weighted partitioned B
  and direct-sub B deblock-enabled streams. Mixed
  direct/explicit B8x8, residual-bearing direct-sub, broader partitioned
  implicit weighted B, and residual-bearing direct-sub high B deblocking
  remain separate oracle lanes.
- `internal/h264/reconstruct_high.go` has a separate `h264PicturePlanesHigh`
  ...
  lanes for 4:2:0/4:2:2/4:4:4, the CAVLC-only High10 4:2:0 slice-boundary
  deblocking lane, the narrow CAVLC/CABAC non-direct/direct B16x16
  high-deblocking lane, the implicit-weighted B16x16 high-deblocking lane,
  the neutral and implicit-weighted partitioned high-deblocking lanes, the
  neutral/implicit-weighted direct-sub high-deblocking lane, the High
  4:4:4 Predictive-compatible yuv420p12le CAVLC IDR/I IntraPCM lane, and the High10 mixed-P
  Intra4x4/Intra16x16 lane. P IntraPCM, P 8x8-DCT intra, weighted partitioned P, mixed
  direct/explicit B8x8, residual-bearing direct-sub B,
  residual-bearing direct-sub high B deblocking,
  CABAC/chroma/B-slice slice-boundary deblocking, broader
  12-bit and all 14-bit public high bitstreams, and border-exchange modes
...
- `internal/h264/reconstruct_high.go` now consumes high motion internally for
  ...
  IDR/P slices for CAVLC and CABAC, plus CAVLC-only High10 4:2:0
  slice-boundary IDR/P, narrow CAVLC/CABAC non-direct/direct B16x16 high
  deblocking, implicit-weighted B16x16 high deblocking, and narrow
  yuv420p12le CAVLC IDR/I IntraPCM. The High 10 B lane now proves both
  ...
  motion, CAVLC/CABAC partitioned P motion, explicit partitioned B16x8/B8x16/B8x8 motion,
  B16x16 implicit weighting, and partitioned implicit weighted B16x8/B8x16/B8x8
  motion over uint16 refs, with high deblocking admitted only for the proved
  CAVLC/CABAC non-direct/direct B16x16, implicit-weighted B16x16, and
  neutral/implicit partitioned B streams. The P-intra lane admits only Intra4x4/Intra16x16
  ...
  broader partitioned implicit weighted B, residual-bearing direct-sub high B deblocking,
  other chroma/depth combinations, and MBAFF remain guarded.
...
4:2:0 IDR/P, residual P16x16, explicit weighted P16x16, partitioned P16x8/P8x16/P8x8,
non-direct B16x16, temporal/spatial direct B16x16, temporal/spatial B-skip,
CAVLC/CABAC B 8x8/B_SUB_4x4 direct-sub, explicit partitioned B16x8/B8x16/B8x8,
implicit weighted B16x16, partitioned implicit weighted B16x8/B8x16/B8x8,
narrow CAVLC/CABAC B16x16 high-deblock, implicit-weighted B16x16 high-deblock, neutral and implicit-weighted partitioned
B16x8/B8x16/B8x8 high-deblock, CAVLC-only High10 slice-boundary, narrow
yuv420p12le IntraPCM, and deblock-enabled 32x32 IDR/P vectors including narrow
High 10 4:2:2/4:4:4 rows across all
...
| Entropy-to-state | CAVLC/CABAC frame-MB handoff, residuals, motion caches, direct motion, and high IntraPCM payload sizing exist; high CAVLC/CABAC slice loops now carry deblock-disabled I pictures plus proved High 10 P-skip/P16x16 no-residual, exact P16x16 L0 residual, explicit weighted P16x16, mixed-P Intra4x4/Intra16x16 macroblocks, CAVLC/CABAC partitioned P16x8/P8x16/P8x8 macroblocks, exact non-direct B16x16 bidirectional, top-level temporal/spatial direct B16x16, temporal/spatial B-skip, CAVLC/CABAC B 8x8/B_SUB_4x4 direct-sub, explicit partitioned B16x8/B8x16/B8x8, implicit weighted B16x16, partitioned implicit weighted B16x8/B8x16/B8x8, narrow CAVLC/CABAC non-direct/direct B16x16 deblock-enabled macroblocks, implicit-weighted B16x16 high-deblock macroblocks, neutral and implicit-weighted partitioned B16x8/B8x16/B8x8 high-deblock macroblocks, neutral B-skip and neutral/implicit-weighted B 8x8/B_SUB_4x4 direct-sub high-deblock macroblocks, deblock-enabled 32x32 IDR/P subsets, CAVLC-only High10 4:2:0 slice-boundary IDR/P subsets, and narrow yuv420p12le CAVLC IDR/I IntraPCM through reconstruction. | Add high-specific regression cases where QP exceeds 51 only with matching public proof. P IntraPCM, P 8x8-DCT intra, weighted partitioned P, mixed direct/explicit B8x8, residual-bearing direct-sub B, broader partitioned implicit B, and residual-bearing direct-sub high B deblocking stay guarded. |
| Internal frame storage | `DecodedFrame` now has uint16 high planes, `newSimpleDecodedFrame` allocates them for 9/10/12/14-bit SPS values, `picturePlanesHigh()` validates them, the simple DPB can expose `RefsHigh`, public `Frame` can carry `Y16/Cb16/Cr16`, and public frame planes are cloned on export so caller mutation cannot corrupt decoder-owned refs. | Keep mixed direct/explicit B8x8, residual-bearing direct-sub B, residual-bearing direct-sub high B deblocking, GBR, and unproved depth/chroma combinations guarded until matching bitstream oracles land. |
| Intra reconstruction | Internal high IntraPCM/intra16x16/intra4x4/intra8x8 call sites exist and are oracle-covered; the simple high slice path now decodes deblock-disabled High 10 4:2:0 CAVLC/CABAC IDR/I fixtures, mixed-P Intra4x4/Intra16x16 public output, and a High 4:4:4 Predictive-compatible yuv420p12le CAVLC IDR/I IntraPCM fixture. | Broaden public intra coverage to P IntraPCM, P 8x8-DCT intra, 14-bit, broader 12-bit, 4:2:2/4:4:4, lossless variants, and mixed B streams only after matching oracles land. |
| Inter/motion reconstruction | 8-bit `hl_motion` is integrated for P/B, weighted P, implicit B, direct B, and 4:4:4 planes. High `h264HLMotionFrame*` is now ported for internal MB-level 4:2:0/4:2:2/4:4:4 motion, explicit/implicit weighting, and edge emulation; High 10 P-skip/P16x16 no-residual, exact P16x16 L0 residual, explicit weighted P16x16, mixed-P Intra4x4/Intra16x16, CAVLC/CABAC partitioned P16x8/P8x16/P8x8, exact non-direct B16x16 standard bidirectional avg, top-level temporal/spatial direct B16x16, temporal/spatial B-skip, CAVLC/CABAC B 8x8/B_SUB_4x4 direct-sub, explicit partitioned B16x8/B8x16/B8x8, implicit weighted B16x16, partitioned implicit weighted B16x8/B8x16/B8x8, narrow CAVLC/CABAC non-direct/direct B16x16 high deblocking, implicit-weighted B16x16 high deblocking, neutral and implicit-weighted partitioned B16x8/B8x16/B8x8 high deblocking, neutral B-skip plus neutral/implicit-weighted B 8x8/B_SUB_4x4 direct-sub high deblocking, and deblock-enabled IDR/P outputs are now wired through public slice/frame output. | P IntraPCM, P 8x8-DCT intra, weighted partitioned P, mixed direct/explicit B8x8, residual-bearing direct-sub B, broader partitioned implicit B, residual-bearing direct-sub high B deblocking, other chroma/depth, and MBAFF stay guarded until each gets bitstream/oracle proof. |
| Loop filter integration | 8-bit frame-picture strength/call-site integration works post-frame for the simple path; high deblock kernels are wired for High10 4:2:0/4:2:2/4:4:4 frame pictures with source-shaped `qp_bd_offset` threshold indexing, internal high 4:2:2/4:4:4 edge-dispatch tests, public CAVLC/CABAC 32x32 deblock-enabled IDR/P fixtures, narrow CAVLC/CABAC non-direct/direct B16x16 deblock-enabled fixtures, implicit-weighted B16x16 high-deblock fixtures, neutral and implicit-weighted partitioned B16x8/B8x16/B8x8 high-deblock fixtures, neutral B-skip plus neutral/implicit-weighted B 8x8/B_SUB_4x4 direct-sub high-deblock fixtures, and a CAVLC-only High10 4:2:0 `disable_deblocking_filter_idc == 2` slice-boundary fixture. | Add CABAC/chroma/B-slice public high slice-boundary proof, residual-bearing direct-sub high B-deblock proof, broader 12-bit/all 14-bit fixtures, and row-threaded/border-exchange scheduling before broadening the public contract. |
| Public output | Public `Frame` exposes cloned `Y/Cb/Cr` and `Y16/Cb16/Cr16` planes plus `RawPixelFormat`, `RawYUVSize`, `BytesPerSample`, `AppendRawYUV16`, and `AppendRawYUVBytesLE`; `AppendRawYUV` remains 8-bit-only; High 10 deblock-disabled I output, no-residual P-skip/P16x16 output, exact P16x16 L0 residual output, explicit weighted P16x16 output, mixed-P Intra4x4/Intra16x16 output, CAVLC/CABAC partitioned P16x8/P8x16/P8x8 output, exact non-direct B16x16 output, temporal/spatial direct B16x16 output, temporal/spatial B-skip output, CAVLC/CABAC B 8x8/B_SUB_4x4 direct-sub output, explicit partitioned B16x8/B8x16/B8x8 output, implicit weighted B16x16 output, partitioned implicit weighted B16x8/B8x16/B8x8 output, CAVLC/CABAC non-direct/direct B16x16 high-deblock output, implicit-weighted B16x16 high-deblock output, neutral and implicit-weighted partitioned B16x8/B8x16/B8x8 high-deblock output, neutral B-skip plus neutral/implicit-weighted B 8x8/B_SUB_4x4 direct-sub high-deblock output, deblock-enabled 4:2:0/4:2:2/4:4:4 IDR/P output, CAVLC-only High10 4:2:0 slice-boundary deblocking IDR/P output, and High 4:4:4 Predictive-compatible yuv420p12le CAVLC IDR/I IntraPCM output are proved against FFmpeg rawvideo MD5s. | Keep P IntraPCM, P 8x8-DCT intra, weighted partitioned P, mixed direct/explicit B8x8, residual-bearing direct-sub B, broader partitioned implicit B, residual-bearing direct-sub high B deblocking, CABAC/chroma/B-slice public high slice-boundary mode, GBR, MBAFF, broader 12-bit, and all 14-bit public high bitstreams guarded. |
| Oracle fixtures | Kernel oracles cover high primitives; public frame-MD5 fixtures cover 8-bit High-profile streams, true High 10 CAVLC/CABAC deblock-disabled IDR/I fixtures, true High 10 IDR/P P-skip/P16x16 no-residual fixtures, true High 10 exact P16x16 L0 residual fixtures, true High 10 explicit weighted P16x16 fixtures, true High 10 mixed-P Intra16x16 fixtures with internal Intra4x4 guard/reconstruction proof, true High 10 CAVLC/CABAC partitioned P16x8/P8x16/P8x8 fixtures, true High 10 non-direct B16x16 fixtures, true High 10 temporal/spatial direct B16x16 fixtures, true High 10 temporal/spatial B-skip fixtures, true High 10 CAVLC/CABAC B 8x8/B_SUB_4x4 direct-sub fixtures, true High 10 CAVLC/CABAC explicit partitioned B16x8/B8x16/B8x8 fixtures, true High 10 implicit weighted B16x16 fixtures, true High 10 CAVLC/CABAC partitioned implicit weighted B16x8/B8x16/B8x8 fixtures, true High 10 CAVLC/CABAC non-direct/direct B16x16 deblock-enabled fixtures, true High 10 CAVLC/CABAC implicit-weighted B16x16 deblock-enabled fixtures, true High 10 CAVLC/CABAC neutral and implicit-weighted partitioned B16x8/B8x16/B8x8 deblock-enabled fixtures, true High 10 neutral B-skip and CAVLC/CABAC neutral/implicit-weighted B 8x8/B_SUB_4x4 direct-sub deblock-enabled fixtures, true High 10 deblock-enabled CAVLC/CABAC 32x32 IDR/P fixtures for 4:2:0/4:2:2/4:4:4, true High 10 CAVLC-only 4:2:0 slice-boundary IDR/P fixture, and a High 4:4:4 Predictive-compatible yuv420p12le CAVLC IDR/I IntraPCM fixture across Annex B/AVC/configured surfaces. The same proved classes are now promoted into the file-backed corpus manifest for repeatable testvector and benchmark runs. | Build later oracle targets for P IntraPCM, P 8x8-DCT intra, weighted partitioned P, mixed direct/explicit B8x8, residual-bearing direct-sub B, broader partitioned implicit B, residual-bearing direct-sub high B deblocking, CABAC/chroma/B-slice public slice-boundary mode, broader 12-bit, and 14-bit deblocking without widening this guard. |
...
deblock-enabled 32x32 IDR/P slices, CAVLC-only High10 4:2:0 slice-boundary
IDR/P, and narrow yuv420p12le CAVLC IDR/I IntraPCM may reach public output. The B guard opened
...
B16x8/B8x16/B8x8, implicit weighted B16x16, narrow CAVLC/CABAC B16x16
high deblocking, implicit-weighted B16x16 high deblocking, and
neutral/implicit-weighted partitioned B high deblocking, now proved by rawvideo
oracles. Weighted partitioned P, mixed direct/explicit B8x8, residual-bearing direct-sub
B, residual-bearing direct-sub high B deblocking, and unproved
depth/chroma combinations remain
guarded.
...
10. High partitioned implicit weighted B. Done for High 10 4:2:0 frame-only,
    deblock-disabled CAVLC/CABAC B16x8, B8x16, and B8x8 streams with
    `weighted_bipred_idc == 2`, public Annex B, AVC, configured AVC,
    sample-by-sample decode, delayed flush, corpus manifest, fixture syntax
    assertions, and FFmpeg rawvideo proof.
...
- Macroblocks stay inside one proved family: B16x16 non-direct with explicit
  ...
  zero, explicit non-direct B16x8/B8x16/B8x8 partitions, or the proved
  partitioned implicit weighted B16x8/B8x16/B8x8 subset. Mixed
  direct/explicit B8x8, residual-bearing direct-sub, and broader partitioned
  implicit B stay guarded.
- PPS weighted bipred remains neutral (`weighted_bipred_idc == 0`) for
  deblock-disabled direct-sub and explicit-partition fixtures; implicit
  weighted B is limited to proved B16x16, partitioned B16x8/B8x16/B8x8, and
  CBP-zero direct-sub high-deblock streams.
...
3. Narrow 10-bit 4:2:0 CAVLC/CABAC non-direct/direct B16x16 with deblocking enabled.
4. CAVLC-only slice-boundary mode `disable_deblocking_filter_idc == 2` for
   multi-slice High10 4:2:0 IDR/P.
5. Later: 12-bit 4:2:2 deblocking, 14-bit 4:4:4 deblocking, CABAC/chroma/B-slice
   slice-boundary, and residual-bearing direct-sub high B deblocking.
...
10. High-depth explicit partitioned B16x8/B8x16/B8x8. Done for CAVLC and
    ...
    future oracle lanes.
11. High-depth partitioned implicit weighted B16x8/B8x16/B8x8. Done for CAVLC
    and CABAC; broader partitioned implicit B remains a future oracle lane.
12. High-depth neutral and implicit-weighted partitioned B16x8/B8x16/B8x8 deblocking.
    Done for CAVLC/CABAC High10 4:2:0 frame-only streams, with B16x8/B8x16
    no-residual and B8x8 explicit-sub residual coverage.
13. High-depth implicit-weighted B16x16 deblocking. Done for CAVLC/CABAC
    High10 4:2:0 frame-only streams with residual-bearing B16x16 BI
    macroblocks; the comparator shows syntax/control-flow parity, not a
    standalone visible filter delta.
14. High-depth implicit-weighted B 8x8/B_SUB_4x4 direct-sub deblocking.
    Done for CAVLC/CABAC High10 4:2:0 frame-only CBP-zero streams across
    temporal/spatial direct-sub and direct_8x8_inference on/off variants.
15. High-depth deblocking enabled for 4:2:0, 4:2:2, and 4:4:4.
16. Annex B, explicit AVC/NALFF, configured AVC, sample-by-sample configured
...
9. **Wire High B Motion**
   - Done for exact non-direct B16x16 standard bidirectional avg, top-level
     ...
     CAVLC/CABAC B 8x8/B_SUB_4x4 direct-sub, implicit weighted B16x16,
     explicit partitioned B16x8/B8x16/B8x8, and partitioned implicit weighted
     B16x8/B8x16/B8x8. Separate narrow CAVLC/CABAC non-direct/direct B16x16
     and implicit-weighted B16x16 deblock-enabled streams prove high B
     deblocking only for those macroblock shapes.
   - Tests: non-direct, direct B16x16, B-skip, CAVLC/CABAC direct-sub,
     implicit weighted B, explicit partitioned B, and partitioned implicit
     weighted B rawvideo MD5, configured sample-by-sample decode, delayed output
     and flush.
...
10. **Wire High Loop Filter**
   - Done for High10 4:2:0/4:2:2/4:4:4 frame-picture post-frame filtering with
     ...
     edge-dispatch tests, internal high slice-boundary cache proof,
     deblock-enabled 32x32 IDR/P CAVLC/CABAC rawvideo oracle fixtures, narrow
     CAVLC/CABAC non-direct/direct and implicit-weighted B16x16 high-deblock
     rawvideo oracle fixtures, and a public CAVLC-only
     High10 4:2:0 `disable_deblocking_filter_idc == 2` slice-boundary rawvideo
     oracle fixture.
   - Remaining tests: CABAC/chroma/B-slice public high slice-boundary proof,
     residual-bearing direct-sub high B deblocking, broader 12-bit/all 14-bit, and
