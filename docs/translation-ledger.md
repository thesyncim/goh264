...
| public decoder/output | `decoder.go`, `simple_decode.go` | partial | corpus, FATE, FFmpeg oracle fixtures including High12 no-residual, internal High12 weighted/unweighted P-skip/P16x16/partitioned P plus no-deblock/mode-1 deblock scope with unweighted 4:2:2/4:4:4 I/P chroma deblock, High10 weighted 4:2:2/4:4:4 chroma P no-deblock, 4:2:0 I/P slice-boundary mode-2 deblock, High10/High12 unweighted 4:2:2/4:4:4 I/P chroma slice-boundary mode-2 deblock, and High12/High14 luma/chroma residual |
