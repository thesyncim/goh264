...
| public decoder/output | `decoder.go`, `simple_decode.go` | partial | corpus, FATE, FFmpeg oracle fixtures including High12 no-residual, internal High12 weighted/unweighted P-skip/P16x16/partitioned P plus mode-1 deblock scope with unweighted 4:2:2/4:4:4 I/P chroma deblock, and High12/High14 luma/chroma residual |
